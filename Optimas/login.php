...
//  var_dump($password);
    $password_hash = crypt($password,'$2a$07$sillysaltforoptimasasdasdasdasd$');
...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/fonts/flag-icon-css/css/flag-icon.min.css">
    <link rel="stylesheet" type="text/css" href="css/vendors/css/extensions/pace.css">
    <!-- END VENDOR CSS-->
    <!-- BEGIN ROBUST CSS-->
    <link rel="stylesheet" type="text/css" href="css/css/bootstrap-extended.css">
    <link rel="stylesheet" type="text/css" href="css/css/app.css">
    <link rel="stylesheet" type="text/css" href="css/css/colors.css">
    <!-- END ROBUST CSS-->
    <!-- BEGIN Page Level CSS-->
    <link rel="stylesheet" type="text/css" href="css/css/core/menu/menu-types/vertical-menu.css">
    <link rel="stylesheet" type="text/css" href="css/css/core/menu/menu-types/vertical-overlay-menu.css">
    <link rel="stylesheet" type="text/css" href="css/css/pages/login-register.css">
    <!-- END Page Level CSS-->
