        ...
        <div id="page-wrapper">
           ...
           <div class="row">
             <div class="col-lg-12 spacer-top">
               <h1 class="page-header">Nová objednávka</h1>
               <form method="POST" action="script/add_offer.script.php">
                 <div class="form-group col-md-12">
                   <label for="nasecisloobjednavky">Zákazník</label>
                    ...
                    <div class="form-group col-md-3">
                      <label for="objednavkuprijal">Objednávku přijal</label>
                      <input type="text" name="prijal" class="form-control" id="objednavkuprijal" placeholder="Kotol">
                    </div>

                    <div class="form-group col-md-3">
                      <label for="klientcisloobjednavky">Číslo objednávky zákazníka</label>
                      <input type="text" name="cislo_obj_jejich" class="form-control" id="klientcisloobjednavky" placeholder="2456">
                    </div>
                    <div class="form-group col-md-3">
                      ...
                      <div class="col-md-12">
                        ...
                        <table class="form-table col-md-12 .table-striped table-condensed " id="customFields">
                          <tr>
                        	...
                        	<tr>
                        		<td><input type="text" class="form-control produkt" id="customFieldValue" name="customFieldValue[1]" value="" placeholder="Input Value" /></td>
                   ...
                   <div class="col-md-12">
                       <button type="submit" name="pridat_objednavku" class="btn btn-success">Přidat objednávku</button>
                  </div>
              </form>
