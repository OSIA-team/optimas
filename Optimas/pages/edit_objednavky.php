            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 nahled">
                        <h1 class="page-header spacer-top">Editace objednavky <?php echo $objednavka_info['cislo_obj_nase']; ?></h1>
                          <form method="post" action="script/edit_objednavka.script.php">
                           <div class="col-md-12 spacer-top">
                            ...
                            <div class="form-group col-md-4">
                              <label for="nasecisloobjednavky">Číslo objednávky zákazníka</label>
                               <input type="text" name="cislo_obj_jejich" class="form-control" id="objednavka klient" Value="<?php echo $objednavka_info['cislo_obj_jejich']; ?>" />
                            </div>
                            <div class="form-group col-md-4">
                              <label for="nasecisloobjednavky">Datum objednávky</label>
                               <input type="date" name="datumobjednavky" class="form-control" id="zakaznik" value="<?php echo $objednavka_info['datumobjednavky']; ?>"/>
                            </div>
                            <div class="col-md-4">
                              <label for="objednavkupřijal">Objednavku přijal</label>
                             <input type="text" name="prijal" class="form-control" id="objednavkuprijal" Value="<?php echo $objednavka_info['prijal']; ?>" />
                           </div>
                            <div class="form-group col-md-4">
                              <label for="nasecisloobjednavky">Naše číslo objednávky</label>
                            ...
                            <div class="form-group col-md-4">
                              <label for="nasecisloobjednavky">Datum vyřízení</label>
                               <input type="date" name="datumvyrizeni" class="form-control" id="zakaznik" value="<?php echo ($objednavka_info['datumvyrizeni'] == "0000-00-00")?"":$objednavka_info['datumvyrizeni']; ?>"/>
                            </div>
                            <div class="col-md-4">
                              <label for="objednavkuvyridil">Objednavku vyřídil</label>
                             <input type="text" name="vyridil" class="form-control" id="objednavkuvyridil" Value="<?php echo ($objednavka_info['vyridil'] == "")?"":$objednavka_info['vyridil']; ?>" />
                           </div>
                            <div class="form-group col-md-2">
                              ...
                              <select name="jakvyridil" class="form-control" id="Dopravce">
                                <?php
                                 ...
                                 ?>
                                <option
                                <?php echo ($dopravce_info['id'] == $dopravce_selected_info['id'])?"selected":""; ?>
                                value="<?php echo $dopravce_info['id']; ?>"><?php echo $dopravce_info['nazev']; ?></option>
                                <?php
                            ...
                            <div class="col-md-12">
                              ...
                              <br>
                                <div class="form-group col-md-3 spacer-top">
                                  <label for="sleva">Sleva za objednávku (%)</label>
                                  <input type="text" name="sleva" class="form-control" id="sleva" value="<?php echo $objednavka_info['sleva']; ?>" >
                                </div>
                              <div class="col-md-11 spacer-top"><span class="pull-right"><b>Celkem za objednávku </b> <span id="SumaNabidka">0</span></span></div>
                            </div>
                          </div>
                          <div class="spacer-top col-md-12">
                            ...
                            <button name="objednavka_edit" class="btn btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Editovat objednavku</button>
                          </div>
                          </div>
                        </form>
		                </div>
