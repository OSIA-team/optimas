...
$jednani_info = $jednani->getAllJednani();
        ...
        <div id="page-wrapper">
           ...
           <div class="row">
             <div class="bunka col-md-12">
                 <h1 class="page-header spacer-top">Všechny jednání</h1>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
                                         ...
                                         ?>
                                            <tr class="odd clickable-table gradeX" onclick="window.document.location='?page=jednani&id=<?php echo $jednani['id']; ?>';">
