...
if (@isset($_GET['delete']) AND $_GET['delete']== true) {
  ...
  if (@isset($_GET['zmen']) AND $_GET['zmen'] == "true") {

    $zmenStav = $objednavka->zmenStav($objednavka_id);
    if ($zmenStav) {
      echo "<script> window.location.href = 'index.php?page=objednavka&id=$objednavka_id';</script>";
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 nahled">
                      <div class="">
                        <a href="?page=nova_nabidka"class="btn btn-warning"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Nová nabidka</a>
                      </div>
                    ...
                    <?php
                     ...
                     ?>
                        <h1 class="page-header spacer-top">Náhled nabídky <?php echo $objednavka_info['cislo_obj_nase']; ?></h1>
                            ...
                            <div class="bunka col-md-4"><strong>Datum nabídky</strong><br><strong><?php echo $objednavka_info['datumobjednavky']; ?></strong></div>
	                      		<div class="bunka col-md-8"><strong>Nabídku vystavil</strong><br><?php echo $objednavka_info['prijal']; ?></div>
	                      	 	</div>
	                      	<div class="col-md-12">
                          ...
                          <div class="col-md-7 nabidka" style="margin-top: 30px;">
                          ...
                          <div class="spacer-top col-md-12">
                            <div class="col-md-6">
                              <a href="nabidka.php?id=<?php echo $objednavka_id; ?>" target="_blank" class="btn btn-warning">
                                <i class="fa fa-file-pdf-o" aria-hidden="true"></i> Generovat PDF
                              </a>
                            <a href="?page=nabidka&id=<?php echo $objednavka_id; ?>&zmen=true" class="btn btn-warning">
                              <i class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></i> Vytvořit objednávku
                            </a>
                            </div>
                            <div class="col-md-6 text-right">
                            <a href="?page=edit_nabidky&id=<?php echo $objednavka_id; ?>"class="btn btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Editovat nabídku</a>
                            <a href="?page=objednavka&id=<?php echo $objednavka_id; ?>&delete=true"class="btn btn-danger" onclick="return confirm('Opravdu chcete smazat tuto objednavku?')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Smazat nabídku</a>
                          </div>
                          </div>
		                </div>
                    <!-- /.col-lg-12 -->
