...
$objednavky_info  = $objednavka->getObjednavkyByStav(false, false, " nabidka = 0");
...
<div id="wrapper">
    <div id="page-wrapper">
       ...
       <div class="row">
         <div class="col-md-12">
             <h1 class="page-header spacer-top">Nevyřízené objednávky</h1>
            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                  <?php
                                   ...
                                   ?>
                                      <tr onclick="window.document.location='?page=objednavka&id=<?php echo $objednavka_info['id']; ?>';" class="danger">
